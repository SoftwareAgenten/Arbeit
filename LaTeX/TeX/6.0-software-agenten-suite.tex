...
\item
  ...
  verfasst, welche auf allen gängigen Computer-Betriebsystemen
  \footnote{Darunter: \emph{Linux}, \emph{FreeBSD}, \emph{Unix}, \emph{Windows}
...
Bestandteil des Dateisystems sind, werden bei der ersten Ausführung der
