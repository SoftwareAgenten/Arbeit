\section{Künstliche Intelligenz} % (fold)
\label{sec:kunstliche_intelligenz}
\subsection{Honeypot} % (fold)
\label{sub:honeypot}
...
% subsubsection honeypot_definition (end)
% subsection honeypot (end)
% section kunstliche_intelligenz (end)